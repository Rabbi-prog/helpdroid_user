                                              ...
                                              onTap: () async {
                                                if (_loginForm.currentState
                                                  ...
                                                  firestoreInstance
                                                    ...
                                                    pref.setString('name', _userName.text, );
                                                    pref.setString('phn', _phone
                                                        .text);
                                                    pref.setString('phn2', _phone2.text);
                                                    pref.setString('phn3', _phone3.text);
                                                    pref.setString('address', _address.text);
                                                    pref.setBool('sex',  sex);
